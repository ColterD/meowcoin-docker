    ...
    async call(method, params = []) {
        try {
            ...
            if (response.data.error) {
                throw new common_1.AppError(common_1.ErrorCode.BLOCKCHAIN_ERROR, `RPC Error: ${response.data.error.message}`, 500, response.data.error);
            }
            ...
            // TODO: Add logger to shared and use here
            throw new common_1.AppError(common_1.ErrorCode.BLOCKCHAIN_ERROR, `Failed to call RPC method: ${method}`, 500, error);
        }
    }
    // Blockchain methods
